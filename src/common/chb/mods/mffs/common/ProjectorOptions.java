...
public enum ProjectorOptions {
	...
	public static void initialize(){
		...
		for (ProjectorOptions mach : ProjectorOptions.values()){
			...
			if(ModularForceFieldSystem.ic2found) RecipesFactory.addRecipe(mach.recipeic, 1, 1, null, mach.item);
			if(ModularForceFieldSystem.uefound)  RecipesFactory.addRecipe(mach.recipeue, 1, 2, null, mach.item);
